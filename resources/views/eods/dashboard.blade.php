...
<div class="col-md-12  ">
    <div class="container-fluid" style="background:#f5f6f7;" >
        <div class=" d-flex justify-content-between pb-2">
            <h4 class="font-large-1 font-weight-bolder mt-0 mb-0">Mass Testing Mega Sites - Inventory </h4>
        </div>
        <div class="row">
                ...
                <div class="row" >
                    @foreach($site->inventories as $inventory)
                        <div class="col-sm-4   flex-column">
                                    ...
                                    @if ($inventory->item)
                                        @if($inventory->item->name == "PCR")
                                    <div class="income3">  <img src="/app-assets/images/icons/placeholder.svg" /> 
                                    @elseif ($inventory->item->name == "ART")
                                    <div class="income">  <img src="/app-assets/images/icons/syringe.svg" />
                                    @else
