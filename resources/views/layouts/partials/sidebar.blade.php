           ...
           <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                @endif
                   ...
                   <li class=" nav-item"><a class="d-flex align-items-center" href=""><i
                       ...
                       <ul class="menu-content">
                           ...
                           <li class="{{ Request::is('user') ? 'active' : '' }}"><a class="d-flex align-items-center"
                                   href="{{ route('user.index') }}"><i data-feather="circle"></i><span
                                       class="menu-item" data-i18n="Details">List</span></a>
                           </li>
                       </ul>
                   </li>
                   {{-- Regions --}}
                   <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                               ...
                               data-i18n="Dashboards">Regions</span></a>
                       <ul class="menu-content">
                           <li class="{{ Request::is('region/create') ? 'active' : '' }}"><a
                                   class="d-flex align-items-center" href="{{ route('region.create') }}"><i
                                       data-feather="circle"></i><span class="menu-item"
                                       data-i18n="Shop">Add</span></a>
                           </li>
                           <li class="{{ Request::is('region') ? 'active' : '' }}"><a
                                   class="d-flex align-items-center" href="{{ route('region.index') }}"><i
                                       data-feather="circle"></i><span class="menu-item"
                   ...
                   {{-- Site --}}
                   <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                               data-feather="thermometer"></i><span class="menu-title text-truncate"
                               data-i18n="Dashboards"> Site</span></a>
                       <ul class="menu-content">
                           <li class="{{ Request::is('site/create') ? 'active' : '' }}"><a
                                   class="d-flex align-items-center" href="{{ route('site.create') }}"><i
                                       data-feather="circle"></i><span class="menu-item"
                                       data-i18n="Shop">Add</span></a>
                           </li>
                           <li class="{{ Request::is('site') ? 'active' : '' }}"><a class="d-flex align-items-center"
                                   href="{{ route('site.index') }}"><i data-feather="circle"></i><span
                                       class="menu-item" data-i18n="Details">List</span></a>
                           </li>
                       </ul>
                   </li>
                   {{-- Item --}}
                   <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                               data-feather="archive"></i><span class="menu-title text-truncate" data-i18n="Dashboards">
                               Item</span></a>
                       <ul class="menu-content">
                           <li class="{{ Request::is('item/create') ? 'active' : '' }}"><a
                                   class="d-flex align-items-center" href="{{ route('item.create') }}"><i
                                       data-feather="circle"></i><span class="menu-item"
                                       data-i18n="Shop">Add</span></a>
                           </li>
                           <li class="{{ Request::is('item') ? 'active' : '' }}"><a class="d-flex align-items-center"
                                   href="{{ route('item.index') }}"><i data-feather="circle"></i><span
                                       class="menu-item" data-i18n="Details">List</span></a>
                           </li>
                       </ul>
                   </li>
                   ...
                   {{-- Module --}}
                   <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                               data-feather="x-circle"></i><span class="menu-title text-truncate"
                               data-i18n="Dashboards">Module</span></a>
                       <ul class="menu-content">
                           <li class="{{ Request::is('module/create') ? 'active' : '' }}"><a
                                   class="d-flex align-items-center" href="{{ route('module.create') }}"><i
                                       data-feather="circle"></i><span class="menu-item"
                                       data-i18n="Shop">Add</span></a>
                           </li>
                           <li class="{{ Request::is('module') ? 'active' : '' }}"><a
                                   class="d-flex align-items-center" href="{{ route('module.index') }}"><i
                                       data-feather="circle"></i><span class="menu-item"
                                       data-i18n="Details">List</span></a>
                           </li>
                       </ul>
               ...
               @if (Auth::user()->type == 'agent' && in_array('Waiting Time', Auth::user()->modulesNameArr()))
                   <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                               ...
                               data-i18n="Dashboards">MT hourly checklist status</span></a>
                       <ul class="menu-content">
                           <li class="{{ Request::is('waiting/create') ? 'active' : '' }}"><a
                                   class="d-flex align-items-center" href="{{ route('waiting.create') }}"><i
                                       data-feather="circle"></i><span class="menu-item"
                                       data-i18n="Shop">Add</span></a>
                           </li>
                           <li class="{{ Request::is('waiting') ? 'active' : '' }}"><a
                                   class="d-flex align-items-center" href="{{ route('waiting.index') }}"><i
                                       data-feather="circle"></i><span class="menu-item"
                                       data-i18n="Details">List</span></a>
                           </li>
               ...
               @if (Auth::user()->type == 'agent' && in_array('Rapid Antigen Testing Site Audit', Auth::user()->modulesNameArr()))
                   <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                               ...
                               data-i18n="Dashboards">Rapid Antigen Site Audid</span></a>
                       <ul class="menu-content">
                           <li class="{{ Request::is('ratsas/create') ? 'active' : '' }}"><a
                                   class="d-flex align-items-center" href="{{ route('ratsas.create') }}"><i
                                       data-feather="circle"></i><span class="menu-item"
                                       data-i18n="Shop">Add</span></a>
                           </li>
                           <li class="{{ Request::is('ratsas') ? 'active' : '' }}"><a
                                   class="d-flex align-items-center" href="{{ route('ratsas.index') }}"><i
                                       data-feather="circle"></i><span class="menu-item"
                                       data-i18n="Details">List</span></a>
                           </li>
                       </ul>
               ...
               @if (Auth::user()->type == 'agent' && in_array('Lab Classification', Auth::user()->modulesNameArr()))
                   <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                               ...
                               data-i18n="Dashboards">Lab Per Shift Submission</span></a>
                       <ul class="menu-content">
                           <li class="{{ Request::is('checklist/create') ? 'active' : '' }}"><a
                                   class="d-flex align-items-center" href="{{ route('checklist.create') }}"><i
                                       data-feather="circle"></i><span class="menu-item"
                                       data-i18n="Shop">Add</span></a>
                           </li>
                           <li class="{{ Request::is('checklist') ? 'active' : '' }}"><a
                                   class="d-flex align-items-center" href="{{ route('checklist.index') }}"><i
                                       data-feather="circle"></i><span class="menu-item"
                                       data-i18n="Details">List</span></a>
                           </li>
                       </ul>
